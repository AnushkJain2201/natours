...
// // Creating router to seperate routes for each resources
...
// // The express.router() will return a middleware so we have to use with the app. This is called mounting the router
